...
# second step of the EYFN tutorial. It joins the PSP peers to the
# channel previously setup in the BYFN tutorial and install the
# chaincode as version 2.0 on peer0.PSP.
#
...
infoln "Joining PSP peer to the channel..."
joinChannel 4

infoln "Setting anchor peer for PSP..."
setAnchorPeer 4

successln "Channel '$CHANNEL_NAME' joined"
successln "PSP peer successfully added to network"
