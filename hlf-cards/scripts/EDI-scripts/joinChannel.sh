...
# second step of the EYFN tutorial. It joins the AAD peers to the
# channel previously setup in the BYFN tutorial and install the
# chaincode as version 2.0 on peer0.AAD.
#
...
infoln "Joining EDI peer to the channel..."
joinChannel 7

infoln "Setting anchor peer for EDI..."
setAnchorPeer 7

successln "Channel '$CHANNEL_NAME' joined"
successln "EDI peer successfully added to network"
