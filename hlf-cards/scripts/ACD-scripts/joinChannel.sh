...
# second step of the EYFN tutorial. It joins the ACD peers to the
# channel previously setup in the BYFN tutorial and install the
# chaincode as version 2.0 on peer0.ACD.
#
...
infoln "Joining ACD peer to the channel..."
joinChannel 5

infoln "Setting anchor peer for ACD..."
setAnchorPeer 5

successln "Channel '$CHANNEL_NAME' joined"
successln "ACD peer successfully added to network"
