...
peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --channelID channel1 --name SubmitSettlementTxCC --version $1.0 --package-id $CC_PACKAGE_ID --sequence $2 --tls --cafile "${PWD}/../organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem" --signature-policy 'AND('\''AADMSP.member'\'','\''AODMSP.member'\'')' --waitForEvent
